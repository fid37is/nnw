  ...
  return (
    <div ref={ref as any}
      ...
      <div className="relative inline-block mb-3">
        <div className={`absolute inset-0 ${color.replace('text','bg')}/10 rounded-2xl blur-xl group-hover:blur-2xl transition-all`}/>
        <span className={`relative text-6xl md:text-7xl font-black ${color} tabular-nums`}>{count.toLocaleString()}</span>
      </div>
    ...
    <section ref={ref as any} className="py-20 bg-white border-b border-gray-100">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ...
          {/* Subtle background */}
          <div className="absolute inset-0 bg-gradient-to-br from-gray-50 to-white border-2 border-gray-100 rounded-3xl"/>
          ...
          {stats.total === 0 && (
            <div className="absolute inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm rounded-3xl">
              <div className="text-center px-8">
                <div className="flex items-center justify-center w-12 h-12 bg-naija-green-100 rounded-xl mb-3 mx-auto"><ShieldCheck size={24} className="text-naija-green-600"/></div>
