export default function FAQSection() {
    ...
    return (
        <section className="bg-gradient-to-br from-naija-green-900 via-naija-green-800 to-naija-green-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-naija-green-700/20">
                <div className="mb-16 text-center">
                    <h2 className="text-4xl md:text-5xl font-black text-white mb-4">Frequently Asked Questions</h2>
                    <p className="text-naija-green-100 text-lg">Find answers to common questions</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
                    {faqs.map((faq, idx) => (
                        <div
                            key={idx}
                            className="group p-8 bg-primary/10 backdrop-blur-md rounded-2xl border border-primary/20 hover:border-naija-gold hover:ring-2 hover:ring-naija-gold/50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 hover:bg-primary/15"
                        >
                            <h3 className="font-black text-white text-lg mb-4 group-hover:text-naija-gold transition-colors">
                                {faq.question}
                            </h3>
                            <p className="text-naija-green-100 leading-relaxed">
                                {faq.answer}
                            </p>
                        </div>
                    ))}
