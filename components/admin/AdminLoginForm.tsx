...
// No local createBrowserClient import needed here anymore.
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 text-center">
              <a href="https://naijaninja.net" className="text-xs text-gray-400 hover:text-gray-600 transition">← Back to main site</a>
            </div>
          </div>
        </div>
