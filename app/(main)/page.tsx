...
export const metadata: Metadata = {
  ...
  description: "Nigeria's premier obstacle-course sports entertainment franchise. Apply to compete, watch live events, and follow the nation's top athletes battle through the ultimate Next challenge.",
  ...
  openGraph: {
    ...
    url:         BASE_URL,
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "Naija Next Warrior" }],
  },
