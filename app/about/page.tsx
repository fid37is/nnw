    ...
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 mt-14">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-muted-foreground">Africa's First Ninja Competition Series</p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="bg-gradient-to-br from-info-50 to-accent-50 rounded-xl p-8 border border-info-200">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="font-bold text-foreground mb-4 text-xl">Community Impact</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
